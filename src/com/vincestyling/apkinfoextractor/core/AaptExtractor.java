...
//		output = "package: name='cn.chinabus.main' versionCode='1107' versionName='9.9.107'";
...
//		test();
	...
	public static void run() throws Exception {
		...
		for (File file : files) {
//			if (!file.getAbsolutePath().contains("lockfun")) continue;
			System.out.println("\n\n>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
...
//			System.out.println(output + "\n-------------------------------");
			...
			codeSB.append("new PackageInfo(\"" + info.label + "\", \"" + info.icon + "\", \"" + info.pkg + "\", \"" + info.versionCode + "\", \"" + info.versionName + "\", \"" + info.launchActivity + "\"),").append('\n');
		}
