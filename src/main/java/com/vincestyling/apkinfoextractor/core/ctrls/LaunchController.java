...
import com.vincestyling.apkinfoextractor.core.export.ExportDialog;
...
public class LaunchController extends BaseTableController implements ApkHandleCallback {
	@FXML
	private ProgressBar prgHandle;
	@FXML
	private Label txfTotal;
	@FXML
	private Label txfProcessed;
	@FXML
	private Label txfSuccess;
	@FXML
	private Label txfFailure;
